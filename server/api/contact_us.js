...
api.post('/contact-us-data', function (req, res) {
    ...
    connetctSQL.query("INSERT INTO `contactus`(`time`, `date_am`, `date_en`, `date_ru`, `date_fr`, `phone`, `address_am`, `address_en`, `address_ru`, `address_fr`, `email`, `lang_am`, `lang_en`, `lang_ru`, `lang_fr`, `facebook`, `instagram`, `linkedin`, `twitter`, `lat`, `lot`) VALUES ('" + req.body.time + "','" + req.body.date_am + "','" + req.body.date_en + "','" + req.body.date_ru + "','" + req.body.date_fr + "','" + req.body.phone + "','" + req.body.address_am + "','" + req.body.address_en + "','" + req.body.address_ru + "','" + req.body.address_fr + "','" + req.body.email + "','" + req.body.lang_am + "','" + req.body.lang_en + "','" + req.body.lang_ru + "','" + req.body.lang_fr + "','" + req.body.facebook + "','" + req.body.instagram + "','" + req.body.linkedin + "','" + req.body.twitter + "','" + req.body.lat + "','" + req.body.lot + "')", function (err, result, fields) {
            if (err) throw err;
