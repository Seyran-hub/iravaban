...
api.put('/user-data', function (req, res) {
    req.body = replace(req.body, true)
    if (JSON.parse(req.body.token) == token) {
        connetctSQL.query("UPDATE `user` SET `name_am`='" + req.body.name_am + "',`name_en`='" + req.body.name_en + "',`name_ru`='" + req.body.name_ru + "',`name_fr`='" + req.body.name_fr + "',`surname_am`='" + req.body.surname_am + "',`surname_en`='" + req.body.surname_en + "',`surname_ru`='" + req.body.surname_ru + "',`surname_fr`='" + req.body.surname_fr + "',`surname_fr`='" + req.body.surname_fr + "',`content_am`='" + req.body.content_am + "',`content_en`='" + req.body.content_en + "',`content_ru`='" + req.body.content_ru + "',`content_fr`='" + req.body.content_fr + "',`facebook`='" + req.body.facebook + "',`instagram`='" + req.body.instagram + "',`linkedin`='" + req.body.linkedin + "',`twitter`='" + req.body.twitter + "',`email`='" + req.body.email + "',`position_am`='" + req.body.position_am + "',`position_en`='" + req.body.position_en + "',`position_ru`='" + req.body.position_ru + "',`position_fr`='" + req.body.position_fr + "' WHERE id='" + req.body.id + "'", function (err, result, fields) {
            if (err) throw err;
            res.status(201).json({ result });
        });
    }
